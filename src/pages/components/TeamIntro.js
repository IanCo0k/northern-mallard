  ...
  return (
    <div className="relative">
      ...
      <div className="container mx-auto text-center relative z-10 py-24">
        <h1 className="text-4xl md:text-6xl font-bold text-white leading-tight">Meet Our Team</h1>
        <p className="mt-4 text-lg md:text-xl text-gray-300">Dedicated to finding you the best thrifted goods across the state of Michigan.</p>
      </div>
    </div>
  );
}
